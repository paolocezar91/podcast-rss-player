...
export default function Tooltip({
  ...
  const updatePosition = () => {
    ...
    switch (newPosition) {
      case "top":
        ...
        left =
          5 + triggerRect.left + triggerRect.width / 2 - tooltipRect.width / 2;
        break;
      case "bottom":
      ...
      case "left":
        ...
        left = 5 + triggerRect.left - tooltipRect.width;
        break;
      case "right":
        top = triggerRect.top + triggerRect.height / 2 - tooltipRect.height / 2;
        left = 5 + triggerRect.right;
        break;
    }
  ...
  const arrowStyleForPosition = (pos: TooltipPosition) => {
    const size = 6; // px
    const common: any = {
      position: "absolute",
      width: 0,
  ...
  return (
    <div className="tooltip-container w-full flex justify-center">
      <div
        ref={triggerRef}
        className="tooltip-trigger w-full flex justify-center"
      ...
      {state.isVisible && (
        <div
          ...
          id="tooltip-content"
          role="tooltip"
          className={`fixed bg-gray-800 text-white text-sm shadow-md max-w-[300px] z-[9999] pointer-events-none leading-5 rounded py-2 px-3 ${className}`}
          style={{
        ...
        >
          ...
          <div
            aria-hidden="true"
            style={arrowStyleForPosition(state.finalPosition)}
          />
        </div>
      )}
    </div>
